...
$(document).on("input", "#legalHeadRemarks", function () {
...
var _approve = {
    ...
    Dropdown: async function () {
        ...
        try {
            ...
            const selectElement1 = document.getElementById('selectBranch');
    ...
    noticeTypeDropdown: async function () {
        ...
        try {
            const requestData = {
                "employeeId": sessionStorage.getItem("EmployeeId"),
                "token": sessionStorage.getItem("Token"),
                "indata": encryptAES($("#selectBranch").val() + "~" + "3"),
                "BranchId": sessionStorage.getItem("BranchId"),
                "enindata": sessionStorage.getItem("BranchId"),
                "flag": encryptAES("8")
            };
    ...
    LegalFetch: async function () {
        ...
        document.getElementById("riimHead").value = values[10];
        document.getElementById("riimHeadRemarks").value = values[11];
    },
    ...
    ah_update: async function () {
        try {
            const caseCatDrp = document.getElementById('selectBranch').value;
            ...
            if (document.getElementById('legalHeadRemarks').value == "") {
                await showAlert("Alert!", "Please Enter Remarks..!!");
                return;
            }

            var data = {
                "indata": encryptAES($("#noticeType").val() + "~" + $("#legalHeadRemarks").val()),
                "employeeId": sessionStorage.getItem("EmployeeId"),
                "token": sessionStorage.getItem("Token"),
                "BranchId": sessionStorage.getItem("BranchId"),
                "flag": encryptAES("14"),
            ...
            if (data2.status == "True") {
                await showSuccessAlert("success!", "Successfully Updated", "/LegalNotice/LegalLh_recommend");
            }
            else {
                await showAlert("Alert!", "Error occured..Please try again..", "warning");
            }
    ...
    lh_reject: async function () {
        try {
            ...
            var data = {
                "indata": encryptAES($("#noticeType").val() + "~" + $("#legalHeadRemarks").val() + "~" + "1"),
                "employeeId": sessionStorage.getItem("EmployeeId"),
                "token": sessionStorage.getItem("Token"),
                "BranchId": sessionStorage.getItem("BranchId"),
                "flag": encryptAES("15"),
            ...
            if (data2.status == "True") {
                ...
                await showSuccessAlert("success!", "Successfully Returned", "/LegalNotice/LegalLh_recommend");
            }
            else {
                await showAlert("Alert!", "Error occured..Please try again..", "warning");
            }
    ...
    all_Clear: function () {
        ...
        document.getElementById("riimHead").value = "";
        document.getElementById("riimHeadRemarks").value = "";
        document.getElementById("legalHeadRemarks").value = "";
    }
