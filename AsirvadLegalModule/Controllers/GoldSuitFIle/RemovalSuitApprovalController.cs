...
{
    public class RemovalSuitApprovalController : Controller
    {
        PrivateAPIManager privateAPI;
        public RemovalSuitApprovalController(PrivateAPIManager privateAPI)
        {
        ...
        public IActionResult RemovalSuitApproval()
        {

            return View("~/Views/GoldSuitFIle/RemovalSuitApproval.cshtml");
        }
        [HttpPost("GetDetailsRemovals")]
