...
namespace DBAccessLibrary
{
    public class OracleHelper
    {
        ...
        public OracleHelper()
        {
            ...
            //strConnectionString = "data source =CLOUDPROD; persist security info = True; user id = aml_gloan; Enlist = false; password = wsd#1234";
            strConnectionString = new AppConfigureManager().GetConnectionString;
